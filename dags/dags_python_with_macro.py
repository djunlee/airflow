...
with DAG(
    ...
    def get_datetime_calc(**kwargs):
        ...
        prev_month_day_first = data_interval_end.in_timezone('Asiz/Seoul') + relativedelta(months=-1, day=1)
        prev_month_day_last = data_interval_end.in_timezone('Asiz/Seoul').replace(day=1) + relativedelta(days=-1)
